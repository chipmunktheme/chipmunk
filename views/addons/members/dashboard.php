...
<?php else : ?>
	<?php
		$first_tab = Chipmunk\Helpers::getOption( 'disable_upvotes' ) ? ( Chipmunk\Helpers::getOption( 'disable_bookmarks' ) ? 'submitted' : 'bookmarked' ) : 'upvoted';
	...
	<div class="c-tabs" data-tabs role="tablist">
		<div class="l-component l-header">
			<div class="c-tabs__title c-heading c-heading--h6">
				<?php if ( ! Chipmunk\Helpers::getOption( 'disable_upvotes' ) ) : ?>
				...
				<?php if ( ! Chipmunk\Helpers::getOption( 'disable_bookmarks' ) ) : ?>
		...
		<?php if ( ! Chipmunk\Helpers::getOption( 'disable_upvotes' ) && $current_tab == 'upvoted' ) : ?>
			<?php echo Chipmunk\Helpers::get_template_part( 'addons/members/dashboard/upvoted' ); ?>
		<?php endif; ?>

		<?php if ( ! Chipmunk\Helpers::getOption( 'disable_bookmarks' ) && $current_tab == 'bookmarked' ) : ?>
			<?php echo Chipmunk\Helpers::get_template_part( 'addons/members/dashboard/bookmarked' ); ?>
		<?php endif; ?>

		<?php if ( ! Chipmunk\Helpers::getOption( 'disable_submissions' ) && $current_tab == 'submitted' ) : ?>
