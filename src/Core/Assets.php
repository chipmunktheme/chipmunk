...
class Assets extends Theme
{
    ...
    {
        $this->addStyle($this->buildThemeSlug('styles', '-'), 'theme.css');
        $this->addScript($this->buildThemeSlug('scripts', '-'), 'theme.js', false, null, true);
    }
    ...
    {
        $this->addStyle($this->buildThemeSlug('admin-styles', '-'), 'admin.css');
    }
