    ...
    <article class="resource row">
      <div class="resource__content column column_lg-6">
        <ul class="resource__stats stats">
          <li class="stats__item" title="Category"><i class="icon icon_tag"></i> Marketing</li>
        ...
        <div class="resource__actions">
          <a href="#" class="button button_secondary" target="_blank">Visit website</a>

          <nav class="nav-socials">
            <h4 class="nav-socials__title">Share</h4>
            <ul>
              <li class="nav-socials__item"><a href="#" title="Twitter"><i class="icon icon_twitter"></i><span class="sr-only">Twitter</span></a></li>
              <li class="nav-socials__item"><a href="#" title="Facebook"><i class="icon icon_facebook"></i><span class="sr-only">Facebook</span></a></li>
            </ul>
          </nav>
          <!-- /.nav-socials -->
        </div>
