<?php if ( ! ChipmunkCustomizer::theme_option( 'disable_newsletter' ) and $action = esc_url( ChipmunkCustomizer::theme_option( 'newsletter_action' ) ) ) : ?>
	<div class="section section_theme-primary text_center">
		<div class="container">
			<h4 class="heading heading_xl"><?php _e( 'Newsletter', 'chipmunk' ); ?></h4>
			<p class="heading heading_thin"><?php echo esc_html( ChipmunkCustomizer::theme_option( 'newsletter_tagline' ) ); ?></p>
