    ...
    <div class="page-foot__inner">
      ...
      <?php if ( ! ChipmunkCustomizer::theme_option( 'disable_credits' ) ) : ?>
        <p class="page-foot__credits">
          <a href="http://chipmunktheme.com" target="_blank" title="<?php _e( 'Chipmunk WordPress Theme', CHIPMUNK_THEME_SLUG ); ?>">
            <?php _e( 'Chipmunk WordPress Theme', CHIPMUNK_THEME_SLUG ); ?>
