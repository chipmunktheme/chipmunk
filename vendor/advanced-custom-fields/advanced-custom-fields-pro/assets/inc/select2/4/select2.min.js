...
! ( function ( n ) {
	...
	const e = ( function () {
			...
			let t; let n; let r; let h; let o; let s; let f; let g; let m; let v; let y; let _; let i; let a; let b;
			function w( e, t ) {
				return i.call( e, t );
			}
			function l( e, t ) {
			...
			return (
				...
				e.define( 'select2/utils', [ 'jquery' ], function ( o ) {
						...
						( i.Decorate = function ( r, i ) {
							...
							function o() {
								const e = Array.prototype.unshift;
									const t = i.prototype.constructor.length;
									let n = r.prototype.constructor;
								t > 0 &&
									( e.call(
										arguments,
					...
					( e.prototype.on = function ( e, t ) {
						...
						( i.hasScroll = function ( e, t ) {
							const n = o( t );
								const r = t.style.overflowX;
								const i = t.style.overflowY;
							return (
								( r !== i ||
									( i !== 'hidden' && i !== 'visible' ) ) &&
								( r === 'scroll' ||
					...
					return (
						...
						( i.StoreData = function ( e, t, n ) {
							const r = i.GetUniqueElementId( e );
							i.__cache[ r ] || ( i.__cache[ r ] = {} ),
								( i.__cache[ r ][ t ] = n );
						} ),
						( i.GetData = function ( e, t ) {
							const n = i.GetUniqueElementId( e );
							return t
								? i.__cache[ n ] && i.__cache[ n ][ t ] != null
									? i.__cache[ n ][ t ]
									: o( e ).data( t )
								: i.__cache[ n ];
						} ),
						( i.RemoveData = function ( e ) {
							const t = i.GetUniqueElementId( e );
							i.__cache[ t ] != null && delete i.__cache[ t ],
					...
					function ( h, f ) {
						...
						return (
							...
							( r.prototype.highlightFirstItem = function () {
								const e = this.$results.find(
										'.select2-results__option[aria-selected]'
									);
									const t = e.filter( '[aria-selected=true]' );
								t.length > 0
							...
							( r.prototype.option = function ( e ) {
								...
								for ( const i in ( ( ( e.element != null &&
									r.call( e.element, ':disabled' ) ) ||
									( e.element == null && e.disabled ) ) &&
									( delete n[ 'aria-selected' ],
									( n[ 'aria-disabled' ] = 'true' ) ),
								e.id == null && delete n[ 'aria-selected' ],
							...
							( r.prototype.template = function ( e, t ) {
								const n = this.options.get( 'templateResult' );
									const r = this.options.get( 'escapeMarkup' );
									const i = n( e, t );
								i == null
					...
					function ( e, t, n, r ) {
						...
						return (
							...
							( i.prototype.render = function () {
								const e = i.__super__.render.call( this );
								return (
							...
							( i.prototype.update = function ( e ) {
								if ( e.length !== 0 ) {
									const t = e[ 0 ];
										const n = this.$selection.find(
											'.select2-selection__rendered'
										);
										const r = this.display( t, n );
									n.empty().append( r );
									const i = t.title || t.text;
									i
										? n.attr( 'title', i )
										: n.removeAttr( 'title' );
								} else this.clear();
					...
					function ( i, e, l ) {
						...
						return (
							...
							( n.prototype.render = function () {
								const e = n.__super__.render.call( this );
								return (
							...
							( n.prototype.update = function ( e ) {
								if ( ( this.clear(), e.length !== 0 ) ) {
									for (
										...
										const r = e[ n ];
											const i = this.selectionContainer();
											const o = this.display( r, i );
										i.append( o );
										const s = r.title || r.text;
										s && i.attr( 'title', s ),
											l.StoreData( i[ 0 ], 'data', r ),
											t.push( i );
									}
									const a = this.$selection.find(
										'.select2-selection__rendered'
									);
									l.appendMany( a, t );
								}
					...
					function ( e ) {
						...
						return (
							...
							( t.prototype.update = function ( e, t ) {
								...
								this.clear();
								const r = this.createPlaceholder(
									this.placeholder
								);
								this.$selection
									.find( '.select2-selection__rendered' )
						...
						return (
							...
							( e.prototype._handleClear = function ( e, t ) {
								if ( ! this.isDisabled() ) {
									...
									if ( n.length !== 0 ) {
										t.stopPropagation();
										const r = a.GetData( n[ 0 ], 'data' );
											const i = this.$element.val();
										this.$element.val(
											this.placeholder.id
										);
										let o = { data: r };
									...
									this.$selection.on(
										...
										function ( e ) {
											if (
												...
												const t = r.$searchContainer.prev(
													'.select2-selection__choice'
												);
												if ( t.length > 0 ) {
													const n = a.GetData(
						...
						return (
							...
							( r.prototype.convertToOptions = function ( e ) {
								...
								for ( let s = 0; s < e.length; s++ ) {
									const a = this._normalizeItem( e[ s ] );
									if ( g.inArray( a.id, r ) >= 0 ) {
										const l = n.filter( o( a ) );
											const c = this.item( l );
											const u = g.extend( ! 0, {}, a, c );
											const d = this.option( u );
										l.replaceWith( d );
									} else {
										const p = this.option( a );
										if ( a.children ) {
											const h = this.convertToOptions(
												a.children
											);
											f.appendMany( p, h );
										}
				...
				e.define( 'select2/data/tags', [ 'jquery' ], function ( u ) {
					function e( e, t, n ) {
						const r = n.get( 'tags' );
							const i = n.get( 'createTag' );
						void 0 !== i && ( this.createTag = i );
						const o = n.get( 'insertTag' );
						if (
						...
						return (
							...
							( e.prototype._detachPositioningHandler = function (
								...
								const n = `scroll.select2.${  t.id}`;
									...
									const i = `orientationchange.select2.${  t.id}`;
								this.$container
									.parents()
									.filter( a.hasScroll )
									.off( n ),
							...
							( e.prototype._positionDropdown = function () {
								const e = f( window );
									const t = this.$dropdown.hasClass(
										'select2-dropdown--above'
									);
									const n = this.$dropdown.hasClass(
										'select2-dropdown--below'
									);
									let r = null;
									const i = this.$container.offset();
								i.bottom =
								...
								const s = this.$dropdown.outerHeight( ! 1 );
									const a = e.scrollTop();
									const l = e.scrollTop() + e.height();
									const c = a < i.top - s;
									const u = l > i.bottom + s;
									const d = { left: i.left, top: o.bottom };
					...
					function ( o ) {
						...
						return (
							...
							( e.prototype._handleSelectOnClose = function (
								...
								const r = this.getHighlightedResults();
								if ( ! ( r.length < 1 ) ) {
									const i = o.GetData( r[ 0 ], 'data' );
									( i.element != null &&
										i.element.selected ) ||
										( i.element == null && i.selected ) ||
					...
					function (
						...
						return (
							( n.prototype.apply = function ( e ) {
								if (
									...
									if (
										...
										const t = u( `${e.amdBase  }compat/query` );
										e.dataAdapter = y.Decorate(
											e.dataAdapter,
											t
										);
								...
								if ( e.selectionAdapter == null ) {
									if (
										...
										e.containerCssClass != null ||
											e.containerCss != null ||
											e.adaptContainerCssClass != null )
									) {
										const o = u(
							...
							( n.prototype.reset = function () {
								...
								this.defaults = {
									...
									matcher: function e( t, n ) {
										...
										const o = a( n.text ).toUpperCase();
											const s = a( t.term ).toUpperCase();
										return o.indexOf( s ) > -1 ? n : null;
									},
							...
							( n.prototype.applyFromElement = function ( e, t ) {
								const n = e.language;
									const r = this.defaults.language;
									const i = t.prop( 'lang' );
									const o = t.closest( '[lang]' ).prop( 'lang' );
									const s = Array.prototype.concat.call(
						...
						return (
							( e.prototype.fromElement = function ( e ) {
								...
								for (
									...
									const o = e[ 0 ].attributes[ i ].name;
										const s = 'data-';
									if ( o.substr( 0, s.length ) == s ) {
										const a = o.substring( s.length );
					...
					function ( o, c, u, r ) {
						var d = function ( e, t ) {
							...
							u.StoreData( e[ 0 ], 'old-tabindex', n ),
								e.attr( 'tabindex', '-1' );
							const r = this.options.get( 'dataAdapter' );
							this.dataAdapter = new r( e, this.options );
							const i = this.render();
							this._placeContainer( i );
							const o = this.options.get( 'selectionAdapter' );
							( this.selection = new o( e, this.options ) ),
								( this.$selection = this.selection.render() ),
								this.selection.position( this.$selection, i );
							const s = this.options.get( 'dropdownAdapter' );
						...
						return (
							...
							( d.prototype._resolveWidth = function ( e, t ) {
								const n = /^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i;
								if ( t == 'resolve' ) {
									const r = this._resolveWidth( e, 'style' );
									return r != null
										? r
										: this._resolveWidth( e, 'element' );
								}
								if ( t == 'element' ) {
									const i = e.outerWidth( ! 1 );
							...
							( d.prototype._syncSubtree = function ( e, t ) {
								const n = this._isChangeMutation( e, t );
									const r = this;
								n &&
									this.dataAdapter.current( function ( e ) {
					...
					function ( i, e, o, t, s ) {
						if ( i.fn.select2 == null ) {
							...
							i.fn.select2 = function ( t ) {
								...
								return (
									this.each( function () {
										const e = s.GetData( this, 'select2' );
										e == null &&
											window.console &&
											console.error &&
											console.error(
									...
									i.inArray( t, a ) > -1 ? this : n
								);
							};
						}
						return (
							i.fn.select2.defaults == null &&
