...
! ( function ( e, a ) {
	...
	if (
		...
		const t = parseInt( window.wpColorPickerAlpha.version, 10 );
		if ( ! isNaN( t ) && o.version <= t ) return;
	}
	Color.fn.hasOwnProperty( 'to_s' ) ||
		( ( Color.fn.to_s = function ( o ) {
			( o = o || 'hex' ) === 'hex' && this._alpha < 1 && ( o = 'rgba' );
			let a = '';
			return (
				o === 'hex'
					? ( a = this.toString() )
		...
		e.widget( 'a8c.iris', e.a8c.iris, {
			...
			_addInputListeners ( i ) {
				function o( o ) {
					var a = i.val();
						const t = new Color( a );
						var a = a.replace( /^(#|(rgb|hsl)a?)/, '' );
						const r = l.alphaOptions.alphaColorType;
			...
			_setOption ( o, a ) {
				const t = this;
				if ( o !== 'color' || ! t.alphaOptions.alphaEnabled )
					return t._super( o, a );
				( a = `${  a}` ),
		...
		e.widget( 'wp.wpColorPicker', e.wp.wpColorPicker, {
			...
			_getAlphaOptions () {
				const r = this.element;
					const o = r.data( 'type' ) || this.options.type;
					const i = r.data( 'defaultColor' ) || r.val();
					const l = {
				...
				return (
					l.alphaEnabled &&
						( l.alphaEnabled = r.is( 'input' ) && o === 'full' ),
					l.alphaEnabled &&
			...
			_addListeners () {
				...
				( this.alphaOptions.defaultWidth = r.width() ),
					...
					t.colorAlpha.css( 'direction' ) === 'ltr'
						? t.colorAlpha.css( {
