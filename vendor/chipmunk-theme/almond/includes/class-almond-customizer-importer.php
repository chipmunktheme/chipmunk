...
class Almond_Customizer_Importer
{
    /**
    ...
    public static function import($customizer_import_file_path)
    {
        ...
        if (is_wp_error($results)) {
            Almond_Logger::get_instance()->error($results->get_error_message());

            return false;
        }

        Almond_Logger::get_instance()->info(__('The customizer import has finished successfully', '@@textdomain'));
        return true;
    }
    ...
    public static function import_customizer_options($import_file_path)
    {
        ...
        // Import images.
        if (apply_filters('almond_customizer_import_images', true)) {
        ...
        if (isset($data['options'])) {
            ...
            foreach ($data['options'] as $option_key => $option_value) {
                $option = new Almond_Customizer_Option($wp_customize, $option_key, array(
                    'default'    => '',
                    'type'       => 'option',
        ...
        $use_wp_customize_save_hooks = apply_filters('almond_enable_wp_customize_save_hooks', false);
     ...
     * @return object An array of image data.
     */
