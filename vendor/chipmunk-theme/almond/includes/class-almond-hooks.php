...
class Almond_Hooks
{
    ...
    {
        add_action('almond_widget_settings_array', array($this, 'fix_custom_menu_widget_ids'));
    ...
    {
        do_action('almond_after_all_import', $selected_import_index);
    ...
    {
        if (!apply_filters('almond_regenerate_thumbnails_in_content_import', true)) {
