<?php
	$options = [
		'display_as' => Chipmunk\Helpers::getOption( 'display_collection_as' ),
	];
...
<div class="<?php echo esc_attr( $tile_class ); ?>">
	<a href="<?php echo esc_url( get_term_link( $collection->term_id ) ); ?>" class="c-tile__inner">
		<?php if ( ! Chipmunk\Helpers::getOption( 'disable_collection_thumbs' ) || $options['display_as'] == 'tile' ) : ?>
			...
			<div class="c-tile__image <?php echo esc_attr( $media_class ); ?>">
				<?php if ( ! Chipmunk\Helpers::getOption( 'disable_collection_thumbs' ) ) : ?>
		...
		<div class="c-tile__content<?php echo ( $options['display_as'] == 'tile' ? ( Chipmunk\Helpers::getOption( 'disable_collection_thumbs' ) ? ' c-tile__content--primary' : ' c-tile__content--dimmed' ) : '' ); ?>">
			...
			<?php if ( ! Chipmunk\Helpers::getOption( 'disable_collection_stats' ) ) : ?>
