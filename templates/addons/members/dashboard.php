...
<?php else : ?>
	<?php
		$first_tab = Chipmunk\Customizer::get_theme_option( 'disable_upvotes' ) ? ( Chipmunk\Customizer::get_theme_option( 'disable_bookmarks' ) ? 'submitted' : 'bookmarked' ) : 'upvoted';
	...
	<div class="c-tabs" data-tabs role="tablist">
		<div class="l-component l-header">
			<div class="c-tabs__title c-heading c-heading--h6">
				<?php if ( ! Chipmunk\Customizer::get_theme_option( 'disable_upvotes' ) ) : ?>
				...
				<?php if ( ! Chipmunk\Customizer::get_theme_option( 'disable_bookmarks' ) ) : ?>
		...
		<?php if ( ! Chipmunk\Customizer::get_theme_option( 'disable_upvotes' ) && $current_tab == 'upvoted' ) : ?>
			<?php echo Chipmunk\Helpers::get_template_part( 'addons/members/dashboard/upvoted' ); ?>
		<?php endif; ?>

		<?php if ( ! Chipmunk\Customizer::get_theme_option( 'disable_bookmarks' ) && $current_tab == 'bookmarked' ) : ?>
			<?php echo Chipmunk\Helpers::get_template_part( 'addons/members/dashboard/bookmarked' ); ?>
		<?php endif; ?>

		<?php if ( ! Chipmunk\Customizer::get_theme_option( 'disable_submissions' ) && $current_tab == 'submitted' ) : ?>
