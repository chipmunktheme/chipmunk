<?php $action = esc_url( Chipmunk\Helpers::getOption( 'newsletter_action' ) ); ?>
...
<?php if ( ! Chipmunk\Helpers::getOption( 'disable_newsletter' ) && ! empty( $action ) ) : ?>
		...
		<div class="l-container">
			<div class="l-wrapper">
				<div class="c-lead c-lead--center">
					...
					<p class="c-lead__content c-content c-content--type"><?php echo esc_html( Chipmunk\Helpers::getOption( 'newsletter_tagline' ) ); ?></p>
					...
					<form action="<?php echo stripslashes( trim( $action, '" ' ) ); ?>" method="post" class="c-lead__cta c-form c-form--inline c-form--narrow" target="_blank" novalidate data-validate>
						...
						<?php if ( ! empty( Chipmunk\Helpers::getOption( 'newsletter_consent' ) ) ) : ?>
							<label class="c-form__field c-form__checkbox" data-consent>
								<input type="checkbox" name="consent" required>
								<p><?php echo esc_html( Chipmunk\Helpers::getOption( 'newsletter_consent' ) ); ?></p>
							</label>
						<?php endif; ?>
						<?php if ( ! empty( $args ) ) : ?>
