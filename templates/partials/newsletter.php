<?php if ( ! chipmunk_theme_option( 'disable_newsletter' ) and $action = esc_url( chipmunk_theme_option( 'newsletter_action' ) ) ) : ?>
	<div class="section section_theme-primary text_center">
		<div class="container">
			...
			<div class="row">
				<form action="<?php echo stripslashes( trim( $action, '" ' ) ); ?>" method="post" class="form form_compact form_centered column column_sm-4 column_sm-offset-1 column_md-4 column_md-offset-1 column_lg-6 column_lg-offset-3" target="_blank" novalidate data-parsley-validate>
