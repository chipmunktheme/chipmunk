<?php
$ad_image_lg = Chipmunk\Customizer::get_theme_option( 'ad_image_lg' );
$ad_image_md = Chipmunk\Customizer::get_theme_option( 'ad_image_md' );
$ad_image_sm = Chipmunk\Customizer::get_theme_option( 'ad_image_sm' );
$ad_link = Chipmunk\Customizer::get_theme_option( 'ad_link' );
$ad_code = Chipmunk\Customizer::get_theme_option( 'ad_code' );

$enabled = ! Chipmunk\Customizer::get_theme_option( 'disable_ads' );
$enabled_home = ( is_front_page() || ! Chipmunk\Customizer::get_theme_option( 'ads_only_home' ) );
