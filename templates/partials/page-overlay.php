        ...
        <div class="c-overlay__inner">
			...
			<?php if ( Chipmunk\Helpers::has_plugin( 'members' ) ) : ?>
				<div class="c-overlay__bottom">
					...
					<?php else : ?>
						<a href="<?php echo esc_url( ChipmunkMembers::get_page_permalink( 'login' ) ); ?>" class="c-button c-button--primary-outline">
							<?php esc_html_e( 'Login', 'chipmunk' ); ?>
						</a>

						<a href="<?php echo esc_url( ChipmunkMembers::get_page_permalink( 'register' ) ); ?>" class="c-button c-button--primary-outline">
