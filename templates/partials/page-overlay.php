<div class="c-overlay u-hidden-lg">
	<div class="c-overlay__inner">
		...
		<?php if ( Chipmunk\Helpers::is_addon_enabled( 'members' ) ) : ?>
			<div class="c-overlay__bottom">
				<?php if ( is_user_logged_in() ) : ?>
					<?php Chipmunk\Helpers::get_template_part( 'partials/submit-button', [ 'class' => 'c-button c-button--primary-outline' ] ); ?>
				<?php else : ?>
		...
		<?php elseif ( ! Chipmunk\Helpers::getOption( 'disable_submissions' ) ) : ?>
			<div class="c-overlay__bottom">
				<?php Chipmunk\Helpers::get_template_part( 'partials/submit-button', [ 'class' => 'c-button c-button--primary-outline' ] ); ?>
			</div>
		<?php endif; ?>
