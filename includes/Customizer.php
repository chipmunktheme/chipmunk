            ...
            [
                ...
                'fields'        => [
                    ...
                    [
                        ...
                        'description' => sprintf(wp_kses(__('Register at <a href="%1$s" target="_blank">reCAPTCHA</a>.', 'chipmunk'), ['a' => ['href' => [], 'target' => []]]), esc_url('https://www.google.com/recaptcha/admin')),
                    ],
                    [
            ...
            [
                ...
                'fields'        => [
                    ...
                    [
                        ...
                        'description' => sprintf(wp_kses(__('We support Mailchimp, ConvertKit, Revue and AWeber. <a href="%1$s" target="_blank">Learn how to find your URL</a>.', 'chipmunk'), ['a' => ['href' => [], 'target' => []]]), esc_url('https://chipmunktheme.com/newsletter-form-url')),
                    ],
                    [
