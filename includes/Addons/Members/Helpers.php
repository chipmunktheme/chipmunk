...
class Helpers {
	...
	/**
	 * Gets a list of resources upvoted by user
	 *
	 * @param integer  $limit   How many posts to display
	 *
	 * @return WP_Query  WP_Query object
	*/
	public static function get_upvoted_resources( $limit = -1, $user = null ) {
		global $paged;

		$db_key = \Chipmunk\Extensions\Upvotes::$db_key;
		...
		return new \WP_Query( array_merge( $args, $sort_args ) );
	}

	/**
	 * Gets a list of resources bookmarked by user
	 *
	 * @param integer  $limit   How many posts to display
	 *
	 * @return WP_Query  WP_Query object
	*/
	public static function get_bookmarked_resources( $limit = -1, $user = null ) {
		global $paged;

		$db_key = \Chipmunk\Extensions\Bookmarks::$db_key;
	...
	/**
	 * Gets a list of resources submitted by user
	 *
	 * @param integer  $limit   How many posts to display
	 *
	 * @return WP_Query  WP_Query object
	*/
	public static function get_submitted_resources( $limit = -1, $user = null ) {
		global $paged;
	...
	/**
	 * Gets the proper user to pull resources from
	 *
	...
	*/
	public static function get_user( $user = null ) {
		...
		return ! empty( $user ) ? $user : $current_user;
	}
