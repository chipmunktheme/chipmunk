...
class Merlin {
	...
	function __construct() {
		...
		add_action( 'admin_head', array( $this, 'addMerlinStyles' ) );
		add_filter( 'merlin_import_files', array( $this, 'importMerlinFiles' ) );
		add_action( 'merlin_after_all_import', array( $this, 'afterImportMerlinFiles' ) );
	}
