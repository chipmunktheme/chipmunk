    ...
    <div class="toolbox">
      <div class="toolbox__share">
        <nav class="nav-socials">
          <h5 class="nav-socials__title"><?php _e('Follow us', CHIPMUNK_THEME_SLUG); ?></h5>
          <ul>
      ...
      <?php if (!ChipmunkCustomizer::theme_option('disable_submissions')) : ?>
        <div class="toolbox__cta visible-md-flex">
          ...
          <button type="button" class="toolbox__button button button_primary" data-popup-toggle><?php _e('Submit', CHIPMUNK_THEME_SLUG); ?></button>
        </div>
      <?php endif; ?>
    </div>
    <!-- /.toolbox -->
