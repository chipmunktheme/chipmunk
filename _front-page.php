...
get_header(); ?>
	...
	<?php if ( ! Chipmunk\Helpers::getOption( 'disable_homepage_listings' ) ) : ?>
	...
	<?php if ( ! Chipmunk\Helpers::getOption( 'disable_homepage_collections' ) ) : ?>
		<?php Chipmunk\Helpers::get_template_part( 'sections/collections' ); ?>
	<?php endif; ?>

	<?php if ( ! Chipmunk\Helpers::getOption( 'disable_homepage_posts' ) ) : ?>
